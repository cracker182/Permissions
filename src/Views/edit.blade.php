            ...
            <div class="uk-width-1-1@s uk-width-3-5@l uk-width-1-3@xl">
                <div class="uk-card uk-card-default">
                    <div class="uk-card-header">
                        {{ __('laralum_permissions::general.edit_permission', ['id' => $permission->id]) }}
                    </div>
                    <div class="uk-card-body">
                        <form method="POST" action="{{ route('laralum::permissions.update', ['permission' => $permission]) }}" class="uk-form-stacked">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <fieldset class="uk-fieldset">
                                ...
                                <div class="uk-margin">
                                    ...
                                    <button type="submit" class="uk-button uk-button-primary uk-align-right">
                                        <span class="ion-forward"></span>&nbsp; {{ __('laralum_permissions::general.edit') }}
                                    </button>
                                </div>
                            </fieldset>
                        </form>
